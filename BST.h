                                ...
                                std::string separator)
{
    if (subtreeRoot != nullptr)
    {
        out << subtreeRoot->data << separator;
        preorderAux(out, subtreeRoot->left, separator);
        preorderAux(out, subtreeRoot->right, separator);
    }
    // add code here
}
...
{
    {
        if (subtreeRoot != nullptr)
        {
            postorderAux(out, subtreeRoot->left, separator);
            postorderAux(out, subtreeRoot->right, separator);
            out << subtreeRoot->data << separator;
        }
        // add code here
    }
